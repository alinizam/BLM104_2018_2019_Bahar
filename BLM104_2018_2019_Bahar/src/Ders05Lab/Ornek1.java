...
public class Ornek1 extends javax.swing.JFrame {
    ...
    public Ornek1() {
        ...
        LbSoyadi.setVisible(false);
        lbAdres.setVisible(false);
    ...
    private void initComponents() {
        ...
        LbSoyadi = new javax.swing.JLabel();
        ...
        lbAdi.setText("Adinda Hata VAr");

        LbSoyadi.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        LbSoyadi.setText("Soyadında Hata Var");

        lbEmail.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbEmail.setText("E mail Hatalı");

        lbTelefon.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbTelefon.setText("Telefon Hatalı");

        lbAdres.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbAdres.setText("Adres Hatalı");
        ...
        txtSoyadi.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtAdres, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtTelefon, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbAdres)
                    .addComponent(lbTelefon)
                    .addComponent(lbEmail)
                    .addComponent(LbSoyadi)
                    .addComponent(lbAdi))
                .addGap(113, 113, 113))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (desenKontrol("[^A-z\\s]", txtAdi.getText())) {
            lbAdi.setVisible(true);
        } else {
            lbAdi.setVisible(false);
        }
        if (desenKontrol("[^A-z\\s]", txtSoyadi.getText())) {
            LbSoyadi.setVisible(true);
        } else {
            LbSoyadi.setVisible(false);
        }
        ...
        if (!desenKontrol("[0][0-9]{3}\\s[0-9]{3}\\s[0-9]{2}\\s[0-9]{2}", txtTelefon.getText())) {
            lbTelefon.setVisible(true);
        } else {
            lbTelefon.setVisible(false);
        }
        
        if (!desenKontrol("\\b[0-9]{5}\\b", txtAdres.getText())) {
            lbAdres.setVisible(true);
        } else {
            lbAdres.setVisible(false);
        }
    ...
    private javax.swing.JLabel LbSoyadi;
